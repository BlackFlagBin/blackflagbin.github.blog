...
到此为止，Retrofit的源码分析终于结束了，其实它并不难，但想要完全理解整个网络访问流程，除了要明白Retrofit，还需要了解OKHttp甚至是RxJava，对后两者不太熟悉的小伙伴们可以看我的另外两篇源码分析：[OkHttp源码分析](http://) ， [RxJava2源码分析](http://) ，在熟悉了OKHttp和RxJava2的基础上再回过头来看

## 写在开头
由于杭州的房价实在太高，所以我可耻的跑路到了西安。几个月前在西安买了房，所以最近总结了一些还算全面的Android面试题。还好成功的通过了西安努比亚的面试，虽然不是阿里、网易这种级别的公司，但对我一个毕业两年的Android开发来说，算是实现了从小公司跳到大公司的。
...
## 工作中解决了什么难题，做了什么有成就感的项目

这个问题其实还是靠平时的积累，对我来说的话，最有成就感的就是开发了[KCommon](https://github.com/BlackFlagBin/KCommonProject)这个项目，它大大提升了我的开发效率。
